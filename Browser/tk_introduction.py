...
class TkIntroduction(object):
    ...
    def get_first_url(self):
        ...
        logger.info('click the foryou page video and enter the single video page')
        time.sleep(5)
    ...
    # 对指定视频进行关注性的播放，love reply and so on
    ...
    # 获取tiktok的用户名,用于判断是否登录成功，同时获取uesr主页地址
